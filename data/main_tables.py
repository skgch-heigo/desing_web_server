...
class Boots(SqlAlchemyBase, SerializerMixin):
    ...
    origin = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    ...
    heel = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    clasp = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
...
class Hats(SqlAlchemyBase, SerializerMixin):
    ...
    popularity_start = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    popularity_end = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    brim = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    features = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    picture = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    deleted = sqlalchemy.Column(sqlalchemy.Integer, nullable=True, default=0)
...
class LowerBody(SqlAlchemyBase, SerializerMixin):
    ...
    popularity_start = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    popularity_end = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    feet = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    clasp = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    length = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    features = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    picture = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    deleted = sqlalchemy.Column(sqlalchemy.Integer, nullable=True, default=0)
...
class UpperBody(SqlAlchemyBase, SerializerMixin):
    ...
    popularity_start = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    popularity_end = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    sleeves = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    clasp = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    collar = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
    hood = sqlalchemy.Column(sqlalchemy.Boolean, nullable=True)
    lapels = sqlalchemy.Column(sqlalchemy.Integer, nullable=True)
